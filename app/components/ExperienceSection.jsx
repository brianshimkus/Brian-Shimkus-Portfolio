...
const experience = [
	{
		...
		bullets: [
			...
			'Deliver full pre-sales artifacts: discovery brief, stakeholder map, technical walkthrough, security assessment, and POV plan tailored to each customer\'s unique systems and constraints.',
